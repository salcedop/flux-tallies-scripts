...
prueba.total_groups = 500

prueba.temperatures = [300.]
#prueba.background_xs = [1.E+10,1000.]

prueba.generate_tallies_xml('/home/salcedop/scripts/tallies.xml',default_group_struc=False)#shem_path='/home/salcedop/scripts/SHEM361.hdf5'$)

#prueba.plot_xs(bps_matrix)

#prueba.download_endf() 

#prueba.run_njoy_arbitrary_struc(default_group_struc=False)
